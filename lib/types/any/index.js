    ...
    _validate(value, state, options, reference) {
        ...
        const finish = () => {
            ...
            if (errors.length && typeof this._flags.error === 'function') {
                ...
                let err = errors[errors.length - 1];
                err = this.createOverrideError(err.type || 'override', change.context || err.context, state, options, change.message || err.message, change.template || err.template);
            }
